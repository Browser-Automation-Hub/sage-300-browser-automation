/**
 * basic-login.js — Basic login example for Sage 300 ERP
...
async function main() {
  ...
  try {
    log('Starting Sage 300 ERP automation (Open Source mode)');
    ...
    const result = await login_sage(page, {
    ...
    // const data = await create_journal_entry(page, {});
    // log('Data:', data);
