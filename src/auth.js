/**
 * auth.js — Authentication handler for Sage 300 ERP
 * Supports: SSO (Active Directory / LDAP), MFA (Sage MFA / Email OTP)
 *
...
const BASE_URL = process.env.SAGE_300_URL || 'https://your-sage300.example.com/sage300/webapi/v1';
const USERNAME = process.env.SAGE_300_USERNAME;
const PASSWORD = process.env.SAGE_300_PASSWORD;
...
async function performLogin(page) {
  if (!USERNAME || !PASSWORD) {
    throw new Error(`Set SAGE_300_USERNAME and SAGE_300_PASSWORD in .env`);
  }

  console.log('Logging in to Sage 300 ERP...');
  await page.goto(BASE_URL, { waitUntil: 'networkidle2' });
